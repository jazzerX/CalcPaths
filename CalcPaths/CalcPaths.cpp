...
// CalcPaths.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCalcPathsApp, CWinApp)
...
// Создание CCalcPathsApp

CCalcPathsApp::CCalcPathsApp() noexcept
{
	...
	SetAppID(_T("CalcPaths.AppID.NoVersion"));
...
BOOL CCalcPathsApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCalcPathsDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CCalcPathsView));
	if (!pDocTemplate)
		return FALSE;
...
int CCalcPathsApp::ExitInstance()
{
...
// Обработчики сообщений CCalcPathsApp
